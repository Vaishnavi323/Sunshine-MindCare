        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
          ...
          <div className="flex space-x-4">
            <button
              ...
              disabled={loading}
              className="group relative bg-[#2a5298] text-white px-6 py-3 rounded-xl font-semibold shadow-md border border-[#2a5298] hover:bg-white hover:text-[#2a5298] transition-all duration-300 ease-in-out overflow-hidden disabled:opacity-50"
            >
              <div className="flex items-center space-x-3">
                {loading ? (
        ...
        {loading && (
          <div className="text-center py-16 bg-white rounded-xl shadow-md border border-gray-300">
            <div className="flex flex-col items-center justify-center">
              ...
              <h3 className="text-xl font-semibold text-[#2a5298] mb-2">Loading Events</h3>
        ...
        {error && !loading && (
          <div className="text-center py-16 bg-white rounded-xl shadow-md border border-gray-300">
            <div className="flex flex-col items-center justify-center">
              ...
              <button
                onClick={handleRefresh}
                className="bg-[#2a5298] text-white px-6 py-3 rounded-xl font-semibold shadow-md hover:bg-white hover:text-[#2a5298] border border-[#2a5298] transition-all duration-300"
              >
                Try Again
              </button>
            </div>
          ...
          >
            ...
            <div className="p-6 bg-white border-t border-gray-200">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center text-gray-600">
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getStatusColor(imageModal.status)}`}>
                    {imageModal.status}
                  </span>
                </div>
              </div>
